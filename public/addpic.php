...
<html lang="fr">
  ...
  <body class="body">
    <?php
        ...
        if (is_uploaded_file($_FILES['screenshot']['tmp_name']) && $_password===";a,8:j5lM,3vY.94mg!!") {
    ...
    <script defer>
        ...
        window.location.href = 'https://www.pierre-le-developpeur.com/displaypic.html?title='+title+'&picture=https://www.pierre-le-developpeur.com/assets/images/'+title+"&password="+password+"&type="+type
    </script>
</html>